...
max_bill = result2.groupby(['USER', pd.Grouper(key = 'TIME', freq = '15D')])['SUBTOTAL_BILL'].sum() #группируем по 15 дней, считаем сумму чеков
...
max_kwt = result2.groupby(['USER', pd.Grouper(key = 'TIME', freq = '15D')])['KWT'].sum()
max_kwt_value = max_kwt.max()
max_kwt_id = max_kwt.idxmax()[0]
max_bill_date = max_kwt.idxmax()[1]
...
```
                           ...
                           KWT                 BILL
    value              126.976              2624.28
    id         49a57420-f36f-1      49a573ee-f36f-1
    time   2013-01-16 00:00:00  2013-01-16 00:00:00
